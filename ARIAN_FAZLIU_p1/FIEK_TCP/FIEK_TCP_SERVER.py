...
def SCANNERSOUND():
    frequency = 2500  # frekuenca = 2500 Hz
    duration = 400  # 0.4 sekonda
        ...
        while True:
            ...
            if message == 'exit':
                ...
                if points[2].isdigit():
                    ...
                    PRINT = "Formati i kerkeses duhet te jete: KONVERTIMI NjesiaPareToNjesiaDyte numri -"
                    conn.send(PRINT.encode("ASCII"))
...
print("TCP server".center(width, '-'))
print("\n")

while True:
    print("Serveri eshte gatshem per te pranuar kerkese".center(width, '-'))
    tcpServer.listen(5)
